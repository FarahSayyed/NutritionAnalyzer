"""
Django settings for Nutrition_Analyzing_Website project.
...
SECRET_KEY = 'django-insecure-xyt7np_qw0l8=jm*7t-42u%k@zflse(y+$3et#!qrrte+z(@-%'
...
MEDIA_ROOT = BASE_DIR / 'media'  # Physical location for uploaded files
